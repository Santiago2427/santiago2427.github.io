...
feelslike2object.onload = function() {
    var weatherData2 = JSON.parse(feelslike2object.responseText);
    
   
        var temp = parseInt(weatherData2.main.temp);
        var windSpeed = parseInt(weatherData2.wind.speed);
        if(temp <= 50) {
            ...
            var relativehum = parseInt(weatherData2.main.humidity);
            var c1 = -42.379;
            var c2 = 2.04901523;
            var c3 = 10.14333127;
            var c4 = -0.22475541;
