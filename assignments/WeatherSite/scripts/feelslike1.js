/* eslint-env browser */
var feelslike1object = new XMLHttpRequest();
feelslike1object.open('get', 'http://api.openweathermap.org/data/2.5/weather?id=4695066&appid=87b778d905abd567949a99734f93fcb2&units=imperial',true);

feelslike1object.send();

feelslike1object.onload = function() {
    var weatherData1 = JSON.parse(feelslike1object.responseText);
    
   
        var temp = parseInt(weatherData1.main.temp);
        var windSpeed = parseInt(weatherData1.wind.speed);
        if(temp <= 50) {
            ...
            var relativehum = parseInt(weatherData1.main.humidity);
            var c1 = -42.379;
            var c2 = 2.04901523;
            var c3 = 10.14333127;
            var c4 = -0.22475541;
